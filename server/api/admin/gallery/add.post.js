...
export default defineEventHandler(async (event) => {
        ...
        if (err || (files.file && !allowedTypes.includes(files.file.mimetype))/*|| files.avatar.size > maxFileSize*/) {
            ...
            try {
                ...
                const picPath = prepareFileInfo(files.file.newFilename, '/public/img/gallery/');
                ...
                added.thumb = thumbnail.substring(thumbnail.indexOf('/img'));
